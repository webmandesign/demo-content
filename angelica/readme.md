...
2. [Download ZIP package](https://github.com/webmandesign/demo-content/raw/master/angelica/angelica.zip) of theme demo files to your computer and unpack the files.
...
If you want to match your website exactly to [the theme demo website](http://wmdemo.eu/angelica/), please install also these plugins:
