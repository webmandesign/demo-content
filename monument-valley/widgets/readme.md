...
You are browsing the demo widgets settings files for [**Monument Valley** WordPress theme by WebMan](https://www.webmandesign.eu/portfolio/monument-valley-wordpress-theme/).
...
It will import all the demo widgets automatically. For more info on one-click demo installation please read [theme documentation](https://www.webmandesign.eu/manual/monument-valley/#demo-content).
...
5. The last step is to reset the "Custom Menu" widget:
  ...
  2. In "Footer Widgets" area set the "Custom Menu: Theme links" widget to display the "Theme Links" menu (you need to have this menu created or imported with theme demo content)
