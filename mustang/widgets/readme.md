...
It will import all the demo widgets automatically. For more info on one-click demo installation please read [theme documentation](https://www.webmandesign.eu/manual/mustang/#demo-content).
...
5. The last step is to reset the "Custom Menu" widget:
  ...
  2. In "Credits Widgets" area set the "Custom Menu: Footer Menu" widget to display the "Main" menu
